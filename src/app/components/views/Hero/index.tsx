    ...
    return (
        <div className='flex lg:flex-row flex-col space-y-20 justify-between items-center'>
            ...
            <div className='space-y-8 max-w-[30rem]'>
                <button aria-label='redirect the user to sale page' className='rounded-md bg-[#e1edff] text-blue-700 font-semibold px-4 py-2 md:mt-0 mt-20'>Sale 70%</button>
                    <h1 className='md:text-5xl text-4xl text-gray-800 font-bold '>An Industrial Take on Streetwear</h1>
                    <p className='text-gray-700 '>Anyone can beat you but no one can beat your outfit as long as you wear Dine outfits.</p>
                <button aria-label='redirect the user to sale page' className='rounded-md bg-[#212121] md:w-36 py-2 px-4 flex items-center gap-x-2'>
